...
public class PhoenixOdometryThread extends Thread {
	...
	/**
	 * Returns the singleton instance of the PhoenixOdometry.
	 ...
	 * Set this thread to be daemon thread instead of a user thread
	 */
	...
	private void waitForAllSignals() {
		...
		try {
			...
			if (isCANFD) {
				...
				// regardless of Pro licensing. No reasoning for this behavior is provided by the documentation.
