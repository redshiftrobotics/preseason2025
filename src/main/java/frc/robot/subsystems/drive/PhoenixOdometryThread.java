...
public class PhoenixOdometryThread extends Thread {
    ...
    /**
     * Starts the thread, this causes JVM to create a new thread which runs currently to this
     * thread, which call the run() method being called in that thread, preventing it from blocking
     * this thread.
     *
     * <p>This method only starts the thread if there are timestamp queues registered to keep track
     * of time.
     */
    @Override
