...
public class Drive extends SubsystemBase {
    ...
    public void periodic() {
        ...
        odometryLock
                .lock(); // Prevents odometry updates while reading data, this is needed as odometry
    ...
    /**
     * Get measured swerve module speeds for each swerve module. Each wheel state is a turn angle
     * and drive velocity in meters/second.
     *
     ...
     *
     * @return a {@link SwerveDriveWheelPositions} object which contains an array of all swerve
     *     module positions
     */
    ...
    public void stopUsingForwardArrangement() {
        Rotation2d[] headings =
                modules().map(module -> new Rotation2d()).toArray(Rotation2d[]::new);
        kinematics.resetHeadings(headings);
        setRobotSpeeds(new ChassisSpeeds());
    }
