...
public class RobotContainer {
                ...
                driverXbox
                        ...
                        .whileTrue(
                                drive.startEnd(
                                                ...
                                                drive::stop)
                                        .withName(
                                                String.format("DriveRobotRelative %s\u00B0", pov)));
                                        ...
                                        .until(
                                                () ->
                                                        input.getOmegaRadiansPerSecond()
                                                                ...
                                                                != 0)
                                        .withName(
                                                String.format("DriveLockedHeading %s\u00B0", pov)));
            }
    ...
    public void updateSmartDashboardOutputs() {
        ...
        SmartDashboard.putNumber(
                "Speed MPH",
                Math.hypot(speeds.vxMetersPerSecond, speeds.vyMetersPerSecond) * 2.2369);
        ...
        SmartDashboard.putString(
                ...
                String.format(
                        "%.2f%%",
                        TeleopDriveController.getSpeedLevel().translationCoefficient * 100));
        SmartDashboard.putString(
                "Speed Rot",
                String.format(
                        "%.2f%%", TeleopDriveController.getSpeedLevel().rotationCoefficient * 100));
    }
