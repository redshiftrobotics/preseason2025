...
import frc.robot.util.JoystickValue;
...
public class RobotContainer {
  ...
  private void configureDriverControllerBindings() {
    if (driverController instanceof CommandXboxController) {
      ...
      final DriveCommands drives =
          new DriveCommands(
              drive,
              new JoystickValue(xbox::getLeftY, -1),
              new JoystickValue(xbox::getLeftX, -1),
              new JoystickValue(xbox::getRightX, -1));

      drive.setDefaultCommand(
          drive
              .run(() -> drive.setRobotSpeeds(drives.getFieldRelativeSpeeds()))
      ...
      final DriveCommands drives =
          new DriveCommands(
              drive,
              new JoystickValue(joystick::getY, -1),
              new JoystickValue(joystick::getX, -1),
              new JoystickValue(joystick::getTwist, -1));

      drive.setDefaultCommand(
          drive
              .run(() -> drive.setRobotSpeeds(drives.getFieldRelativeSpeeds()))
              .withName("Drive Teleop Input Joystick"));
    }
  }
