 ...
 * default if not in tuning mode, or if the value is not in dashboard.
 */
public class LoggedTunableNumber implements DoubleSupplier {
	...
	public LoggedTunableNumber(String dashboardKey, double defaultValue) {
		...
		dashboardNumber = Constants.TUNING_MODE ?
							  new LoggedDashboardNumber(key, defaultValue) :
							  null;
	}
	 ...
	 *     of "hashCode()"
	 * @return True if the number has changed since the last time this method
