...
public class OverrideSwitch implements BooleanSupplier {
	...
	public static enum Mode { TOGGLE, HOLD }
	...
	public OverrideSwitch(
		Trigger trigger, String name, Mode mode, boolean defaultState) {
		this.name = name;

		switch(mode) {
			case TOGGLE: trigger.onTrue(Commands.runOnce(this::toggle)); break;
	...
	private void set(boolean value) {
		...
		if(name != null) { SmartDashboard.putBoolean(name, value); }
	}
